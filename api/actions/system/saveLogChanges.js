    ...
    return devDelay(2000).then(() => {
      ...
      if (!editedName) {
        ...
        reject({
          ...
          errorReason: `No new log name was passed to edit log request.`
        });
        ...
        reject({
          status: 400,
          errorField: 'newLogName',
          errorReason: `The new log name "${editedName}" is invalid. It must be 15 characters or less.`
        });
        ...
        reject({
          ...
          errorReason: `Invalid new group ID was passed to edit log request. No group exists for that ID.`
        });
      } else if (!editedFile) {
        ...
        reject({
          ...
          errorReason: `No new log file name was passed to edit log request.`
        });
        ...
        reject({
          status: 400,
          errorField: 'newLogFile',
          errorReason: `The new log file name "${editedFile}" is invalid. It must be 1000 characters or less.`
        });
      } else if (!editedPath) {
        ...
        reject({
          ...
          errorReason: `No new log file path was passed to edit log request.`
        });
        ...
        reject({
          status: 400,
          errorField: 'newLogPath',
          errorReason: `The new log file path "${editedPath}" is invalid. It must be 1000 characters or less.`
        });
      } else {
