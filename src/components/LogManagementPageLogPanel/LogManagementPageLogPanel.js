    ...
    return (
      <div className={classnames(styles.logManagementPageLogPanel, { [styles.formOpen]: log.editPanelOpen })}>
        ...
        <div className={classnames(styles.formContainer, styles.fadeInPanel, { [styles.open]: log.editPanelOpen })}>
          <div className={styles.lhs}>
            <form onSubmit={(event) => { saveLogChanges(logId, log.name, groupId, log.editedName, log.editedGroup, log.editedFile, log.editedPath); event.preventDefault(); return false; }}>
          ...
          <div className={styles.actions}>
            <button onClick={() => saveLogChanges(logId, log.name, groupId, log.editedName, log.editedGroup, log.editedFile, log.editedPath)}>
              <Icon iconName="check"/>
            </button>
            <button onClick={() => toggleEditOpen(logId)}>
              <Icon iconName="close"/>
