...
@connect(
  ...
  { toggleEditGroupName, toggleDeleteGroup, updateUnsavedGroupName, saveGroupName, deleteGroup })
export default class GroupManagement extends Component {
  ...
  render() {
    const { groups, toggleEditGroupName, toggleDeleteGroup, updateUnsavedGroupName, saveGroupName, deleteGroup } = this.props; // eslint-disable-line
    return !!groups ? <GroupManagementPage groups={groups} toggleEditGroupName={toggleEditGroupName} toggleDeleteGroup={toggleDeleteGroup} updateUnsavedGroupName={updateUnsavedGroupName} saveGroupName={saveGroupName} deleteGroup={deleteGroup} /> : null;
  }
}
